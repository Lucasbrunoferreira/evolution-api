...
import type { ProxyDto } from "@api/dto/proxy.dto";
import type { SettingsDto } from "@api/dto/settings.dto";
import type { ChatwootDto } from "@api/integrations/chatbot/chatwoot/dto/chatwoot.dto";
...
import { Events, type wa } from "@api/types/wa.types";
import type {
	Auth,
	Chatwoot,
	ConfigService,
...
import { type Contact, type Message, Prisma } from "@prisma/client";
...
export class ChannelStartupService {
	...
	public hasValidMediaContent(message: any): boolean {
		...
		if (
			...
			Object.getOwnPropertyDescriptor(msg, "messageContextInfo")
		) {
			return false;
		}
